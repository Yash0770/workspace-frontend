...
export default function Card({ title, description, createdOn }) {
  ...
  return (
    <div className="relative bg-gray-50 shadow-sm border border-gray-200 rounded-xl p-5 hover:shadow-md transition">
      {/* Title */}
      ...
      {/* Divider */}
      <div className="border-t border-gray-200 mb-3 mt-12 md:mt-17" />
